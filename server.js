...
app.get('/MoviePage', function(req, res) {
    ...
    db.collection('MovieInfo').find({title:movieTitle}).toArray(function(err, results) {
        if (err) throw err;
        //console.log(results)
        ...
        if(!results){
            ...
            for(var i = 0; i < results.length; i++){
                ...
                output += "Created By:"+results[i].login.username+"";
                output += "Review:"+results[i].MovieReview.review+""
            }
        }
